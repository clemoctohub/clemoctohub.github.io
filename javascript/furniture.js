class Furniture{
    ...
    constructor(name){
        ...
        switch(name){
            case "Cupboard":
                this.#listObj.push(new Item(3,"Heat_Detector","everywhere",2,"The beeper is ringing a lot and is showing the bedroom direction..",true));
                break;
            case "Tools_Table":
                this.#listObj.push(new Objet(4,"Weapon","Alien",3,""));
                this.#listObj.push(new Key(10,"Bedroom_Key","Dining Room",3,"The bedroom door is open",true));
                break;
            case "Lockers":
