class Room{
    ...
    constructor(name,north,south,east,west,door){
        ...
        switch(name){
            case "Dining Room":
                this.#listObj.push(new Objet(0,"Repair_Manual","none",true,"page 7506.. if you want to repair the robot you have to connect the red wire with the blue wire..."));
                this.#listObj.push(new Objet(1,"Log_Book","none",true,".. we forgot to open the toilet's ventilation system.... On 8th march we found something alive on the planet."+
            ...
            case "Research Basement":
                ...
                this.#listObj.push(new Objet(8,"Alien_Book","none","true","You can detect the alien with its heat. It seems to like a lot human food but is not interested by human itself."));
                ...
                break;
            case "Bedroom":
                this.#listObj.push(new Objet(9,"Navigation_Room_Key","Navigation Door",true,"Navigation Door Open !"));
